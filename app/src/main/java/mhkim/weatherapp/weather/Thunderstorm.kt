...
data class Thunderstorm(override var main: String = "none", override var description: String= "none", override var id: Int= -1, override val icon: Icon?=null):WeatherInterface {
